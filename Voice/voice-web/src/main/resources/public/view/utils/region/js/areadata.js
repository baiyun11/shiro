...
function appendCity(thiscon, Cityxz) {
    ...
    if ($(dataCityinput).data("value") != "") {
        ...
        var inputarryname = $(dataCityinput).data("cityName").split('-');
        ...
        if (inputarry.length > 0) {
            for (var i in inputarry) {
                ...
                //$('.div-data-result').append('<span class="aui-titlespan" data-code="' + inputarry[i] + '" data-name="' + inputarryname[i] + '" onclick="removespan_area(this)">' + inputarryname[i] + '<i>×</i></span>');
            }
        }
    }
...
function selectitem_area(con) {
    if (datatype == "duoxuan") {
        ...
        if ($('.data-result span').length > 2000) {
            ...
            $('.data-result').append('<span class="svae_box aui-titlespan" data-code="' + $(con).data("code") + '" data-name="' + $(con).data("name") + '" onclick="removespan_area(this)">' + $(con).data("name") + '<i>×</i></span>');
            //$('.div-data-result').append('<span class="svae_box aui-titlespan" data-code="' + $(con).data("code") + '" data-name="' + $(con).data("name") + '" onclick="removespan_area(this)">' + $(con).data("name") + '<i>×</i></span>');
...
function svae_City() {
    ...
    if ($('.svae_box').length > 0) {
        $('.svae_box').each(function () {
            ...
            $('.div-data-result').append('<span class="aui-titlespan" data-code="' + $(this).data("code") + '" data-name="' + $(this).data("name") + '">' + $(this).data("name") + '</span>');
        });
    }
    if (val != '') {
    ...
    $(dataCityinput).data("cityName",Cityname);
